...
class StatusbarAppTest {
    ...
    fun testNotificationCenterController() {
        ...
        val sbn = CarNotification(
            "test", "test", "Test AppName", null, true, emptyList(),
            "Title", "line1\nline2 yay",
        ...
        val sbnSecond = CarNotification(
            "test", "test2", "Test AppName", null, true, emptyList(),
            "Title2", "more test",
            null, null, null, null, null
        )
    ...
    fun testID5Popup() {
        ...
        val sbn = CarNotification(
            "test package", "asdf", "Test App Name", mock(),
