...
class MockScenario(context: Context) {
    ...
    val musicApps = ObservableArrayList<MusicAppInfo>().apply {
        add(
            MusicAppInfo("Green Player", context.getDrawable(R.drawable.ic_test_music_app2)!!, "mock", null).apply {
                connectable = true
                browseable = true
                searchable = true
            }
        ...
        add(
            MusicAppInfo("Music Player", context.getDrawable(R.drawable.ic_test_music_app1)!!, "mock", null).apply {
                controllable = true
            }
        )
        add(
            MusicAppInfo("Unsupported Player", context.getDrawable(R.drawable.ic_test_music_app1)!!, "mock", null).apply {
                connectable = false
                hidden = true
            }
        )
