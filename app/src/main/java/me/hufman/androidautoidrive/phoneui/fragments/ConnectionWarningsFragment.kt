...
import me.hufman.androidautoidrive.databinding.ConnectionWarningsBinding
...
class ConnectionWarningsFragment: Fragment() {
	...
	override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
		...
		val binding = ConnectionWarningsBinding.inflate(inflater, container, false)
