...
open class CustomAction(val packageName: String, val action: String, val name: String, private val _iconId: Int, val icon: Drawable?, val extras: Bundle?, val providesAction: MusicAction?) {
    companion object {
        ...
        fun fromMediaCustomAction(context: Context, packageName: String, action: PlaybackStateCompat.CustomAction): CustomAction {
            ...
            return enableDwellAction(
                enableProvidesAction(
                    formatCustomActionDisplay(
    ...
    fun clone(
        ...
        icon: Drawable? = null,
        extras: Bundle? = null,
        providesAction: MusicAction? = null
    ): CustomAction {
        return CustomAction(
            packageName ?: this.packageName, action ?: this.action, name ?: this.name,
...
class CustomActionDwell(
    ...
    icon: Drawable?,
    extras: Bundle?,
    providesAction: MusicAction?
) : CustomAction(packageName, action, name, _iconId, icon, extras, providesAction)
