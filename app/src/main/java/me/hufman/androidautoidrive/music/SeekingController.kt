...
class SeekingController(val context: Context, val handler: Handler, val controller: MusicController) {
    ...
    val seekingActions = listOf(
        CustomActionDwell(
            "me.hufman.androidautoidrive", "MUSIC_ACTION_SEEK_BACK_60", L.MUSIC_ACTION_SEEK_BACK_60,
            0, context.getDrawable(R.drawable.music_seek_back_heavy), null, null
        ),
        CustomActionDwell(
            "me.hufman.androidautoidrive", "MUSIC_ACTION_SEEK_BACK_10", L.MUSIC_ACTION_SEEK_BACK_10,
            0, context.getDrawable(R.drawable.music_seek_back), null, null
        ),
        CustomActionDwell(
            "me.hufman.androidautoidrive", "MUSIC_ACTION_SEEK_FORWARD_10", L.MUSIC_ACTION_SEEK_FORWARD_10,
            0, context.getDrawable(R.drawable.music_seek_forward), null, null
        ),
        CustomActionDwell(
            "me.hufman.androidautoidrive", "MUSIC_ACTION_SEEK_FORWARD_60", L.MUSIC_ACTION_SEEK_FORWARD_60,
